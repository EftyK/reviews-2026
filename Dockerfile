...
LABEL maintainer="daniel.nuest@tu-dresden.de" \
  Name="AGILE reproducibility reviews 2026" \
  org.opencontainers.image.created="2026-02" \
  org.opencontainers.image.authors="Daniel Nüst" \
  org.opencontainers.image.url="https://github.com/reproducible-agile/reviews-2026" \
  org.opencontainers.image.documentation="https://github.com/reproducible-agile/reviews-2026" \
