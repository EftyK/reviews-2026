...
folder_path = r"/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/tracklib"
...
def create_filltered_hda_table(source_table, head, tail, buffer_size, esp, db = 'ResRoute', db_user = 'postgres', db_password = 'postgres', cells = [], bbox = [], bbox_grid = [], time_max=None, d_gap_h = '500'):
    ...
    d  = list(zip(
        ...
        [_to_time(v) for v in tracks_simp.getTimestamps_str()[0:-1]],  # Pull the first 10 data points
        ...
        [_to_time(v) for v in tracks_simp.getTimestamps_str()[1:]],  # Pull the next 10 data points (shifted by 1)
