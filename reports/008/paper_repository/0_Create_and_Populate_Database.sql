...
\COPY Species 	 			    FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/Species.csv'  			CSV HEADER DELIMITER ',';
\COPY trajectories_indivs	FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/trajectories_indivs.csv' CSV HEADER DELIMITER ',';
\COPY Recorded_Animal		  FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/Recorded_Animal.csv'  	CSV HEADER DELIMITER ',';
\COPY indiv_Human			    FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/indiv_Human.csv'  		CSV HEADER DELIMITER ',';
\COPY trajectories			  FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/trajectories.csv'  		CSV HEADER DELIMITER ',';

\COPY Goal     	 			    FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/Goal.csv'				CSV HEADER DELIMITER ',';
\COPY sub_trajectories		FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/sub_trajectories.csv'  	CSV HEADER DELIMITER ',';


\COPY points 		    FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/points.bin' BINARY;
--\COPY points 		  FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/points.csv' 		CSV HEADER DELIMITER ',';
\COPY activity  	  FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/activity.csv' 	CSV HEADER DELIMITER ',';
\COPY environment   FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/environment.csv' CSV HEADER DELIMITER ',';
\COPY movment      	FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/movment.csv' 	CSV HEADER DELIMITER ',';
...
\COPY edges_import FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/edges.csv' WITH (   FORMAT CSV,   HEADER TRUE,   DELIMITER ',',   QUOTE '"',   ESCAPE '"' );
...
\COPY bauges_import FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/bauges.csv' WITH (   FORMAT CSV,   HEADER TRUE,   DELIMITER ',',   QUOTE '"',   ESCAPE '"' );
...
\COPY france_import FROM '/Users/fwelsch/Storage/Workspace/Publications/2026_AGILE_Reproducibility_Review/Sub8_DetectingHumanWildlifeEncounter/data/france.csv' WITH (   FORMAT CSV,   HEADER TRUE,   DELIMITER ',',   QUOTE '"',   ESCAPE '"' );
